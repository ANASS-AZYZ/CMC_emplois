                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="jour" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500" required>
                                <option value="Lundi" data-i18n-app="dayMonday">Lundi</option>
                                <option value="Mardi" data-i18n-app="dayTuesday">Mardi</option>
                                <option value="Mercredi" data-i18n-app="dayWednesday">Mercredi</option>
                                <option value="Jeudi" data-i18n-app="dayThursday">Jeudi</option>
                                <option value="Vendredi" data-i18n-app="dayFriday">Vendredi</option>
                                <option value="Samedi" data-i18n-app="daySaturday">Samedi</option>
                            </select>
                        </div>
