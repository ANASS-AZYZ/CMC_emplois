<x-app-layout>
    <div class="flex flex-col md:flex-row min-h-[calc(100vh-6rem)] py-8">
        <!-- Sidebar Paramètres -->
        <aside class="w-full md:w-72 shrink-0 mb-8 md:mb-0 md:mr-10">
            <div class="rounded-2xl bg-white dark:bg-[var(--app-surface)] border border-gray-100 dark:border-[var(--app-border)] shadow-lg overflow-hidden">
                <div class="px-4 py-3 bg-gray-50 dark:bg-[var(--app-surface-soft)] border-b border-gray-100 dark:border-[var(--app-border)]">
                    <span class="text-xs font-bold tracking-wider text-gray-500 dark:text-gray-400 uppercase">Préférences</span>
                </div>
        ...
        <main class="flex-1 min-w-0 flex justify-center items-start">
